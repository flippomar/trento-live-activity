/* ===========================================================
   ...
   Calm, functional settings. No mouse-glow, reduced animation.
   window.SettingsPage
   =========================================================== */

/* ===================== CARD SHELL ===================== */
function SetCard({ num, title, desc, icon, color, children, full }) {
  return (
...
/* ===================== TOGGLE ROW ===================== */
function SetRow({ label, sub, on, onChange }) {
...
/* ===================== RADIO PILLS ===================== */
function SetRadio({ options, value, onChange }) {
  return (
...
/* ===================== THEME CARDS ===================== */
function SetTheme({ value, onChange }) {
  const opts = [
...
function SetInterests({ value, onChange }) {
...
/* ===================== PAGE ===================== */
function SettingsPage({ page, setPage, theme, setTheme }) {
  /* appearance */
