...
(function () {
  ...
  const catColor = (id) => (CATEGORIES.find((c) => c.id === id) || {}).color || C.cyan;
  ...
  window.TLA = { C, CATEGORIES, catColor, catLabel, MARKERS, PLACES, WEATHER, ALERTS, PARKING, AREAS, EVENTS };
})();
