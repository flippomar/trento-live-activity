/* ===========================================================
   ...
   Curated discovery + trust catalogue. Shares Header, glass
   <Widget>, icons, useGlow, fmt and the .ev-col layout columns.
   window.ActivityPage
   =========================================================== */
...
function ActSortBar({ count, sort, setSort }) {
...
/* ===================== ACTIVITY CARD ===================== */
function ActCard({ a, saved, onSave, onOpen }) {
...
/* ===================== RIGHT — NEXT ===================== */
function ActNextWidget({ saved, onSave, onOpen }) {
...
function TrustedAuthors({ authorFilter, onPick }) {
  const ids = ["g", "l", "o"];
  return (
...
/* ===================== DETAIL DRAWER ===================== */
function ActDrawer({ id, saved, onSave, onClose }) {
  const open = !!id;
...
/* ===================== PAGE ===================== */
function ActivityPage({ page, setPage, theme, setTheme }) {
